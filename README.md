...
I build production-minded AI + backend systems with a focus on quality loops, observability, and clear technical communication.

## What I focus on
- **AI quality engineering**: eval design, regression gates, and rollout safety
- **Backend systems**: APIs, data flows, reliability, and performance
- **Public build logs**: sharing concrete experiments, outcomes, and lessons
